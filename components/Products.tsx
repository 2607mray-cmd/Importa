...
const Products: React.FC<ProductsProps> = ({ onProductSelect, onNavigateToBlog }) => {
                ...
                <div className="pt-4 border-t border-gray-100 mt-auto space-y-3">
                  <div className="flex justify-between items-center">
                   ...
                   <div className="grid grid-cols-2 gap-3">
                        <button
                            onClick={() => setSelectedModalProduct(product.id)}
        ...
        {onNavigateToBlog && (
             <div className="mt-8 text-center">
                <p className="text-gray-500 text-sm">
                    Want to know more about tea grades? <button onClick={onNavigateToBlog} className="text-tea-600 hover:underline">Read our Wholesale Tea Guide</button>
                </p>
            </div>
        )}
      </div>
